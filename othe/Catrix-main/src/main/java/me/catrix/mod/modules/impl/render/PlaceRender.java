...
public class PlaceRender extends Module {
    ...
    private final ColorSetting box = add(new ColorSetting("Box", new Color(153, 150, 239, 178)).injectBoolean(true));
    private final ColorSetting fill = add(new ColorSetting("Fill", new Color(153, 150, 239, 189)).injectBoolean(true));
    ...
    private final EnumSetting<Mode> mode = add(new EnumSetting<>("Mode", Mode.Fade));
    private enum Mode {
        Fade,
        Shrink,
        All,
