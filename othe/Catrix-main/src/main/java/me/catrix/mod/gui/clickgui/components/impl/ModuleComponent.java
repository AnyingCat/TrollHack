...
public class ModuleComponent extends Component {
    ...
    private static final Identifier Expand_icon = new Identifier("textures/gui/expand.png");
...
//					sound();
    ...
    public boolean draw(int offset, DrawContext drawContext, float partialTicks, Color color, boolean back) {
        ...
        if (ClickGui.INSTANCE.gear.getValue()) {
            ...
            if (popped) {
                drawContext.drawTexture(Expand_icon, parentX + parentWidth - 8 - 4, (int) (parentY + currentOffset + (defaultHeight - 8) / 2f), 0, 0, 8, 8, 8, 8);
            } else {
                FontRenderers.miniIcon.drawString(drawContext.getMatrices(),"A",parentX + parentWidth - 8 - 4,(int) (parentY + currentOffset + (defaultHeight - 8) / 2f) + 1,Color.WHITE.getRGB());
            }
