...
import me.catrix.api.events.impl.ClickBlockEvent;
...
import me.catrix.asm.accessors.IPlayerMoveC2SPacket;
...
import me.catrix.mod.modules.impl.combat.AutoCev;
...
public class PacketMine extends Module {
    ...
    public float getDigSpeed(BlockState state, ItemStack itemStack) {
        ...
        boolean inWeb = Catrix.PLAYER.isInWeb(mc.player) && mc.world.getBlockState(breakPos).getBlock() == Blocks.COBWEB;
