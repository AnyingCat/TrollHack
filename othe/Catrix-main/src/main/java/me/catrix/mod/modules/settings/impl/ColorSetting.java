package me.catrix.mod.modules.settings.impl;
...
public class ColorSetting extends Setting {
	...
	public final Color getValue() {
		if (isRainbow) {
			if (Colors.INSTANCE.color.booleanValue) {
				Color preColor = Colors.INSTANCE.color.getValue();
	...
	public void loadSetting() {
		this.value = new Color(Catrix.CONFIG.getInt(this.getLine(), defaultValue.getRGB()), true);
		this.isRainbow = Catrix.CONFIG.getBoolean(this.getLine() + "Rainbow");
		if (injectBoolean) {
			this.booleanValue = Catrix.CONFIG.getBoolean(this.getLine() + "Boolean", defaultBooleanValue);
		}
	}
}
