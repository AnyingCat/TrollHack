...
import me.catrix.mod.gui.mainmenus.CatMenu;
import me.catrix.mod.gui.mainmenus.CatMenu2;
//import me.catrix.mod.gui.mainmenus.MeMenu;
...
public class ClientSetting extends Module {
    ...
    public final EnumSetting<MenuMode> menu = add(new EnumSetting<>("MenuMode", MenuMode.CatMenu2, () -> page.is(Page.Game)));

    public final StringSetting windowTitle = add(new StringSetting("WindowTitle", Catrix.NAME, () -> page.is(Page.Misc)));
    ...
    public final ColorSetting endColor = add(new ColorSetting("End", new Color(0x6EACAFFD,true), () -> page.is(Page.Gui) && customBackground.booleanValue));
    ...
    public final StringSetting hackName = add(new StringSetting("Notification", "[Catrix]", () -> page.getValue() == Page.Notification));
    public final ColorSetting color = add(new ColorSetting("Color", new Color(0x6EACAFFD,true), () -> page.getValue() == Page.Notification));
    public final ColorSetting pulse = add(new ColorSetting("Pulse", new Color(0x6EACAFFD), () -> page.getValue() == Page.Notification).injectBoolean(true));
...
//                case Me -> client.setScreen(new MeMenu());
                case CatMenu -> client.setScreen(new CatMenu());
                case CatMenu2 -> client.setScreen(new CatMenu2());
            }
        }
    }
