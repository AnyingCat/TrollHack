...
public class CatMenu extends Screen implements Wrapper {
    public CatMenu() {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        RenderShadersUtil.drawMainMenuShader(context.getMatrices(), 0, 0, mc.getWindow().getScaledWidth(), mc.getWindow().getScaledHeight());
