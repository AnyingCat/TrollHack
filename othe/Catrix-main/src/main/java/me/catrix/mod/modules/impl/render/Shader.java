...
import me.catrix.core.impl.ShaderManager;
...
public class Shader extends Module {
    ...
    public final EnumSetting<RenderMode> renderMode = add(new EnumSetting<>("RenderMode", RenderMode.Both, () -> page.getValue() == Page.Shader && mode.is(ShaderManager.Shader.Solid)));
    ...
    public boolean shouldRender(Entity entity) {
        ...
        if (entity instanceof PlayerEntity) {
            ...
            if (Catrix.FRIEND.isFriend((PlayerEntity) entity))
    ...
    public void onRender3D(MatrixStack matrixStack) {
        if (hands.getValue())
            Catrix.SHADER.renderShader(()-> mc.gameRenderer.renderHand(matrixStack, mc.gameRenderer.getCamera(), mc.getTickDelta()), mode.getValue());
    }

    @Override
    public void onToggle() {
        Catrix.SHADER.reloadShaders();
    }
