...
import me.catrix.api.interfaces.IChatHudHook;
import me.catrix.api.utils.Wrapper;
import me.catrix.mod.commands.Command;
import me.catrix.mod.commands.impl.*;
...
public class CommandManager implements Wrapper {
    ...
    public void command(String[] commandIn) {
        ...
        Command command = commands.get(commandIn[0].substring(Catrix.PREFIX.length()).toLowerCase());
