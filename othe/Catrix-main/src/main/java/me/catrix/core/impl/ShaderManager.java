...
import me.catrix.api.interfaces.IShaderEffect;
...
public class ShaderManager implements Wrapper {
    ...
    public void setupShader(Shader shader, ManagedShaderEffect effect) {
        me.catrix.mod.modules.impl.render.Shader shaderChams = me.catrix.mod.modules.impl.render.Shader.INSTANCE;
        if (shader == Shader.Rainbow) {
            ...
            effect.setUniformValue("FillOpacity", shaderChams.fill.getValue().getAlpha() / 255f);
            if (shaderChams.renderMode.is(me.catrix.mod.modules.impl.render.Shader.RenderMode.Fill)) {
                effect.setUniformValue("RenderMode", 0);
            } else if (shaderChams.renderMode.is(me.catrix.mod.modules.impl.render.Shader.RenderMode.Outline)) {
                effect.setUniformValue("RenderMode", 1);
            } else if (shaderChams.renderMode.is(me.catrix.mod.modules.impl.render.Shader.RenderMode.Both)) {
                effect.setUniformValue("RenderMode", 2);
            }
            ...
            effect.setUniformValue("radius", 6.0f);
            effect.setUniformValue("divider", 300.0f);
            effect.setUniformValue("maxSample", 20.0f);
