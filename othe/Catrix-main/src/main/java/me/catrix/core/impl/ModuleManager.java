...
import me.catrix.mod.modules.impl.combat.*;
import me.catrix.mod.modules.impl.exploit.*;
import me.catrix.mod.modules.impl.hud.*;
import me.catrix.mod.modules.impl.misc.*;
import me.catrix.mod.modules.impl.movement.*;
import me.catrix.mod.modules.impl.player.*;
import me.catrix.mod.modules.impl.player.freelook.FreeLook;
import me.catrix.mod.modules.impl.render.*;
import me.catrix.mod.modules.settings.Setting;
import me.catrix.mod.modules.settings.impl.BindSetting;
...
public class ModuleManager implements Wrapper {
    ...
    public ModuleManager() {
        ...
        addModule(new Capes());
        addModule(new Sound());
        addModule(new DeathEffects());
        addModule(new HudEditor());
        addModule(new DamageTint());
        addModule(new VClip());
        addModule(new Glide());
    ...
    public void render3D(MatrixStack matrixStack) {
        ...
        Catrix.EVENT_BUS.post(new Render3DEvent(matrixStack, mc.getTickDelta()));
        matrixStack.pop();
