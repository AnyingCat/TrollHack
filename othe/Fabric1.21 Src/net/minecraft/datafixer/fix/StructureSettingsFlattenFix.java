...
extends DataFix {
    ...
    private static Dynamic<?> fixStructures(Dynamic<?> structureSettingsDynamic) {
        ...
        return DataFixUtils.orElse(structureSettingsDynamic.get("stronghold").result().map(strongholdDynamic -> dynamic.set("minecraft:stronghold", strongholdDynamic.set("type", structureSettingsDynamic.createString("minecraft:concentric_rings")))), dynamic);
    }
}
