    ...
    static final class Level {
                    ...
                    switch ((Integer)entry.getKey()) {
                        ...
                        case 26: {
                            ...
                            while (intListIterator.hasNext()) {
                                ...
                                if (dynamic == null || (k = dynamic.get("color").asInt(0)) == 14 || k < 0 || k >= 16 || !BED.containsKey(string2 = ChunkPalettedStorageFix.getProperty(dynamic2, "facing") + ChunkPalettedStorageFix.getProperty(dynamic2, "occupied") + ChunkPalettedStorageFix.getProperty(dynamic2, "part") + k)) continue;
                        ...
                        case 177: {
                            ...
                            while (intListIterator.hasNext()) {
                                ...
                                dynamic = this.getBlockEntity(j |= i);
                                dynamic2 = this.getBlock(j);
                                if (dynamic == null || (k = dynamic.get("Base").asInt(0)) == 15 || k < 0 || k >= 16 || !BANNER.containsKey(string2 = ChunkPalettedStorageFix.getProperty(dynamic2, (Integer)entry.getKey() == 176 ? "rotation" : "facing") + "_" + k)) continue;
        ...
        public static int adjacentTo(int packedLocalPos, Facing direction) {
            switch (direction.getAxis().ordinal()) {
                ...
                case 2: {
                    int k = (packedLocalPos >> 4 & 0xF) + direction.getDirection().getOffset();
