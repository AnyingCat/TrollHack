...
public abstract class StructurePoolElement {
    ...
    public static Function<StructurePool.Projection, LegacySinglePoolElement> ofLegacySingle(String id) {
        return projection -> new LegacySinglePoolElement(Either.left(Identifier.of(id)), EMPTY_PROCESSORS, (StructurePool.Projection)projection, Optional.empty());
    }
    ...
    public static Function<StructurePool.Projection, LegacySinglePoolElement> ofProcessedLegacySingle(String id, RegistryEntry<StructureProcessorList> processorListEntry) {
        return projection -> new LegacySinglePoolElement(Either.left(Identifier.of(id)), processorListEntry, (StructurePool.Projection)projection, Optional.empty());
    }

    public static Function<StructurePool.Projection, SinglePoolElement> ofSingle(String id) {
        return projection -> new SinglePoolElement(Either.left(Identifier.of(id)), EMPTY_PROCESSORS, (StructurePool.Projection)projection, Optional.empty());
    }
    ...
    public static Function<StructurePool.Projection, SinglePoolElement> ofProcessedSingle(String id, RegistryEntry<StructureProcessorList> processorListEntry) {
        return projection -> new SinglePoolElement(Either.left(Identifier.of(id)), processorListEntry, (StructurePool.Projection)projection, Optional.empty());
    }
    ...
    public static Function<StructurePool.Projection, SinglePoolElement> ofSingle(String id, StructureLiquidSettings liquidSettings) {
        return projection -> new SinglePoolElement(Either.left(Identifier.of(id)), EMPTY_PROCESSORS, (StructurePool.Projection)projection, Optional.of(liquidSettings));
    }
    ...
    public static Function<StructurePool.Projection, SinglePoolElement> ofProcessedSingle(String id, RegistryEntry<StructureProcessorList> processorListEntry, StructureLiquidSettings liquidSettings) {
        return projection -> new SinglePoolElement(Either.left(Identifier.of(id)), processorListEntry, (StructurePool.Projection)projection, Optional.of(liquidSettings));
    }
