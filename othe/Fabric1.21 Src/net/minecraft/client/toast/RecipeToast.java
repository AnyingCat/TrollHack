...
implements Toast {
    ...
    public Toast.Visibility draw(DrawContext context, ToastManager manager, long startTime) {
        ...
        RecipeEntry<?> recipeEntry = this.recipes.get((int)((double)startTime / Math.max(1.0, 5000.0 * manager.getNotificationDisplayTimeMultiplier() / (double)this.recipes.size()) % (double)this.recipes.size()));
