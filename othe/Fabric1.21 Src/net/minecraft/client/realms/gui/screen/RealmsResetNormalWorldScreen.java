...
extends RealmsScreen {
    ...
    public void init() {
        ...
        directionalLayoutWidget.add(CyclingButtonWidget.builder(RealmsWorldGeneratorType::getText).values((RealmsWorldGeneratorType[])RealmsWorldGeneratorType.values()).initially(this.generatorType).build(0, 0, 210, 20, Text.translatable("selectWorld.mapType"), (button, generatorType) -> {
            this.generatorType = generatorType;
        }));
        directionalLayoutWidget.add(CyclingButtonWidget.onOffBuilder(this.mapFeatures).build(0, 0, 210, 20, Text.translatable("selectWorld.mapFeatures"), (button, mapFeatures) -> {
