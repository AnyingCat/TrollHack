...
extends RealmsScreen {
    ...
    extends ElementListWidget<InvitedObjectSelectionListEntry> {
        ...
        protected void renderHeader(DrawContext context, int x, int y) {
            ...
            context.drawText(RealmsPlayerScreen.this.textRenderer, text, x + this.getRowWidth() / 2 - RealmsPlayerScreen.this.textRenderer.getWidth(text) / 2, y, Colors.WHITE, false);
        }
    ...
    extends ElementListWidget.Entry<InvitedObjectSelectionListEntry> {
        ...
        private void op(int index) {
            ...
            try {
                ...
                LOGGER.error("Couldn't op the user", realmsServiceException);
            }
            this.refreshOpButtonsVisibility();
        }
        ...
        private void deop(int index) {
            ...
            try {
                ...
                LOGGER.error("Couldn't deop the user", realmsServiceException);
            }
            this.refreshOpButtonsVisibility();
        }
                ...
                RealmsConfirmScreen realmsConfirmScreen = new RealmsConfirmScreen(confirmed -> {
                    if (confirmed) {
                        ...
                        try {
                            ...
                            LOGGER.error("Couldn't uninvite user", realmsServiceException);
                        }
        ...
        public void render(DrawContext context, int index, int y, int x, int entryWidth, int entryHeight, int mouseX, int mouseY, boolean hovered, float tickDelta) {
            int i = !this.playerInfo.isAccepted() ? -6250336 : (this.playerInfo.isOnline() ? 0x7FFF7F : Colors.WHITE);
            int j = y + entryHeight / 2 - 16;
            RealmsUtil.drawPlayerHead(context, x, j, 32, this.playerInfo.getUuid());
            int k = y + entryHeight / 2 - ((RealmsPlayerScreen)RealmsPlayerScreen.this).textRenderer.fontHeight / 2;
