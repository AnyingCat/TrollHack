        ...
        if (screen2 != null) {
            ...
            Screen.wrapScreenError(() -> {
                if (action == 1 || action == 2) {
                    ...
                    bls[0] = screen2.keyPressed(key, scancode, modifiers);
                } else if (action == 0) {
                    bls[0] = screen2.keyReleased(key, scancode, modifiers);
                }
            }, "keyPressed event handler", screen2.getClass().getCanonicalName());
            if (bls[0]) {
                return;
            }
        }
