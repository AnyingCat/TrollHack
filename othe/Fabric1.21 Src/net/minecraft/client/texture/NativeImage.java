...
implements AutoCloseable {
    ...
    public static NativeImage read(@Nullable Format format, ByteBuffer buffer) throws IOException {
        ...
        try (MemoryStack memoryStack = MemoryStack.stackPush();){
            ...
            NativeImage nativeImage = new NativeImage(format == null ? Format.fromChannelCount(intBuffer3.get(0)) : format, intBuffer.get(0), intBuffer2.get(0), true, MemoryUtil.memAddress(byteBuffer));
            return nativeImage;
        }
    }
