...
AutoCloseable {
    ...
    public JsonEffectShaderProgram(ResourceFactory factory, String name) throws IOException {
        Identifier identifier = Identifier.ofVanilla(PROGRAM_DIRECTORY + name + ".json");
        this.name = name;
        ...
        try (BufferedReader reader = resource.getReader();){
            ...
            this.vertexShader = JsonEffectShaderProgram.loadEffect(factory, ShaderStage.Type.VERTEX, string);
            this.fragmentShader = JsonEffectShaderProgram.loadEffect(factory, ShaderStage.Type.FRAGMENT, string2);
    ...
    public static EffectShaderStage loadEffect(ResourceFactory resourceFactory, ShaderStage.Type type, String name) throws IOException {
        ...
        if (shaderStage == null) {
            Identifier identifier = Identifier.ofVanilla(PROGRAM_DIRECTORY + name + type.getFileExtension());
