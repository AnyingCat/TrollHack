...
public class ItemColors {
    ...
    public static ItemColors create(BlockColors blockColors) {
        ...
        itemColors.register((stack, tintIndex) -> tintIndex == 0 ? -1 : ColorHelper.Argb.fullAlpha(stack.getOrDefault(DataComponentTypes.MAP_COLOR, MapColorComponent.DEFAULT).rgb()), Items.FILLED_MAP);
        return itemColors;
    }
