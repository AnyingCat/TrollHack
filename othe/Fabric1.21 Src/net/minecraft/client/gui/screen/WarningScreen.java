...
extends Screen {
    ...
    protected void init() {
        ...
        this.textWidget = directionalLayoutWidget.add(new NarratedMultilineTextWidget(this.width - 100, this.messageText, this.textRenderer, 12), positioner -> positioner.margin(12));
