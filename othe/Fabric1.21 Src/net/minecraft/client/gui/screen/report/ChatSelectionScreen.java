...
extends Screen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawCenteredTextWithShadow(this.textRenderer, text, this.width / 2, 16 + this.textRenderer.fontHeight * 3 / 2, Colors.WHITE);
    ...
    implements MessagesListAdder.MessagesList {
        ...
        extends Entry {
            ...
            private void drawCheckmark(DrawContext context, int y, int x, int entryHeight) {
                ...
                context.drawGuiTexture(CHECKMARK_ICON_TEXTURE, i, j, 9, 8);
