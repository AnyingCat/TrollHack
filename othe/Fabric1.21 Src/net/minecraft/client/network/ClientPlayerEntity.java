...
extends AbstractClientPlayerEntity {
    ...
    public void tickMovement() {
        ...
        if (playerAbilities.allowFlying) {
            if (this.client.interactionManager.isFlyingLocked()) {
                ...
                if (this.abilityResyncCountdown == 0) {
                    ...
                    boolean bl11 = playerAbilities.flying = !playerAbilities.flying;
        ...
        if (this.input.jumping && !bl8 && !bl && !playerAbilities.flying && !this.hasVehicle() && !this.isClimbing() && (itemStack = this.getEquippedStack(EquipmentSlot.CHEST)).isOf(Items.ELYTRA) && ElytraItem.isUsable(itemStack) && this.checkFallFlying()) {
