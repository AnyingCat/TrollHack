...
public class ClientPlayerInteractionManager {
    ...
    private ActionResult interactBlockInternal(ClientPlayerEntity player, Hand hand, BlockHitResult hitResult) {
        ...
        if (!bl2) {
            ...
            if (itemActionResult == ItemActionResult.PASS_TO_DEFAULT_BLOCK_INTERACTION && hand == Hand.MAIN_HAND && (actionResult = blockState.onUse(this.client.world, player, hitResult)).isAccepted()) {
                return actionResult;
            }
        }
