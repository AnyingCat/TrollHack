...
extends IllagerEntityRenderer<IllusionerEntity> {
    ...
    public IllusionerEntityRenderer(EntityRendererFactory.Context context) {
        ...
        this.addFeature(new HeldItemFeatureRenderer<IllusionerEntity, IllagerEntityModel<IllusionerEntity>>(this, (FeatureRendererContext)this, context.getHeldItemRenderer()){
