...
extends SkeletonEntityRenderer<BoggedEntity> {
    ...
    public BoggedEntityRenderer(EntityRendererFactory.Context context) {
        ...
        this.addFeature(new SkeletonOverlayFeatureRenderer<BoggedEntity, SkeletonEntityModel<BoggedEntity>>(this, context.getModelLoader(), EntityModelLayers.BOGGED_OUTER, OVERLAY_TEXTURE));
    }
