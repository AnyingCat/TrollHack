...
extends IllagerEntityRenderer<VindicatorEntity> {
    ...
    public VindicatorEntityRenderer(EntityRendererFactory.Context context) {
        ...
        this.addFeature(new HeldItemFeatureRenderer<VindicatorEntity, IllagerEntityModel<VindicatorEntity>>(this, (FeatureRendererContext)this, context.getHeldItemRenderer()){
