...
extends EntityRenderer<ExperienceOrbEntity> {
    ...
    public void render(ExperienceOrbEntity experienceOrbEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        ...
        ExperienceOrbEntityRenderer.vertex(vertexConsumer, entry, -0.5f, -0.25f, s, 255, u, h, m, i);
        ExperienceOrbEntityRenderer.vertex(vertexConsumer, entry, 0.5f, -0.25f, s, 255, u, k, m, i);
        ExperienceOrbEntityRenderer.vertex(vertexConsumer, entry, 0.5f, 0.75f, s, 255, u, k, l, i);
        ExperienceOrbEntityRenderer.vertex(vertexConsumer, entry, -0.5f, 0.75f, s, 255, u, h, l, i);
        matrixStack.pop();
