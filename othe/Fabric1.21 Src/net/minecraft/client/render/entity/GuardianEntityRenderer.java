...
extends MobEntityRenderer<GuardianEntity, GuardianEntityModel> {
    ...
    public void render(GuardianEntity guardianEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        ...
        if (livingEntity != null) {
            ...
            GuardianEntityRenderer.vertex(vertexConsumer, entry, af, an, ag, s, t, u, 0.4999f, ar);
            GuardianEntityRenderer.vertex(vertexConsumer, entry, af, 0.0f, ag, s, t, u, 0.4999f, aq);
            GuardianEntityRenderer.vertex(vertexConsumer, entry, ah, 0.0f, ai, s, t, u, 0.0f, aq);
            GuardianEntityRenderer.vertex(vertexConsumer, entry, ah, an, ai, s, t, u, 0.0f, ar);
            GuardianEntityRenderer.vertex(vertexConsumer, entry, aj, an, ak, s, t, u, 0.4999f, ar);
            GuardianEntityRenderer.vertex(vertexConsumer, entry, aj, 0.0f, ak, s, t, u, 0.4999f, aq);
            GuardianEntityRenderer.vertex(vertexConsumer, entry, al, 0.0f, am, s, t, u, 0.0f, aq);
            GuardianEntityRenderer.vertex(vertexConsumer, entry, al, an, am, s, t, u, 0.0f, ar);
            float as = 0.0f;
            if (guardianEntity.age % 2 == 0) {
                as = 0.5f;
            }
            GuardianEntityRenderer.vertex(vertexConsumer, entry, x, an, y, s, t, u, 0.5f, as + 0.5f);
            GuardianEntityRenderer.vertex(vertexConsumer, entry, z, an, aa, s, t, u, 1.0f, as + 0.5f);
            GuardianEntityRenderer.vertex(vertexConsumer, entry, ad, an, ae, s, t, u, 1.0f, as);
            GuardianEntityRenderer.vertex(vertexConsumer, entry, ab, an, ac, s, t, u, 0.5f, as);
            matrixStack.pop();
        }
    }
