...
extends FeatureRenderer<BreezeEntity, BreezeEntityModel<BreezeEntity>> {
    ...
    public BreezeWindFeatureRenderer(EntityRendererFactory.Context context, FeatureRendererContext<BreezeEntity, BreezeEntityModel<BreezeEntity>> featureRendererContext) {
