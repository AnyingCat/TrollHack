...
extends EntityRenderer<EnderDragonEntity> {
    ...
    public void render(EnderDragonEntity enderDragonEntity, float f, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int i) {
        ...
        if (enderDragonEntity.ticksSinceDeath > 0) {
            ...
            EnderDragonEntityRenderer.renderDeathAnimation(matrixStack, m, vertexConsumerProvider.getBuffer(RenderLayer.getDragonRays()));
            EnderDragonEntityRenderer.renderDeathAnimation(matrixStack, m, vertexConsumerProvider.getBuffer(RenderLayer.getDragonRaysDepth()));
            matrixStack.pop();
        }
        matrixStack.pop();
        if (enderDragonEntity.connectedCrystal != null) {
            ...
            EnderDragonEntityRenderer.renderCrystalBeam(m, n + EndCrystalEntityRenderer.getYOffset(enderDragonEntity.connectedCrystal, g), o, g, enderDragonEntity.age, matrixStack, vertexConsumerProvider, i);
            matrixStack.pop();
        }
