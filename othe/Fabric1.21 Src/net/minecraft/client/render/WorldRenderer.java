...
AutoCloseable {
        ...
        for (int n = k - l; n <= k + l; ++n) {
            for (int o = i - l; o <= i + l; ++o) {
                ...
                if (precipitation == Biome.Precipitation.RAIN) {
                    ...
                    mutable.set(o, t, n);
                    ac = WorldRenderer.getLightmapCoordinates(world, mutable);
                    bufferBuilder.vertex((float)((double)o - cameraX - d + 0.5), (float)((double)s - cameraY), (float)((double)n - cameraZ - e + 0.5)).texture(0.0f, (float)r * 0.25f + x).color(1.0f, 1.0f, 1.0f, ab).light(ac);
                    bufferBuilder.vertex((float)((double)o - cameraX + d + 0.5), (float)((double)s - cameraY), (float)((double)n - cameraZ + e + 0.5)).texture(1.0f, (float)r * 0.25f + x).color(1.0f, 1.0f, 1.0f, ab).light(ac);
                    bufferBuilder.vertex((float)((double)o - cameraX + d + 0.5), (float)((double)r - cameraY), (float)((double)n - cameraZ + e + 0.5)).texture(1.0f, (float)s * 0.25f + x).color(1.0f, 1.0f, 1.0f, ab).light(ac);
                    bufferBuilder.vertex((float)((double)o - cameraX - d + 0.5), (float)((double)r - cameraY), (float)((double)n - cameraZ - e + 0.5)).texture(0.0f, (float)s * 0.25f + x).color(1.0f, 1.0f, 1.0f, ab).light(ac);
                    continue;
                }
                ...
                float ad = -((float)(this.ticks & 0x1FF) + tickDelta) / 512.0f;
                float ae = (float)(random.nextDouble() + (double)g * 0.01 * (double)((float)random.nextGaussian()));
                h = (float)(random.nextDouble() + (double)(g * (float)random.nextGaussian()) * 0.001);
                ...
                mutable.set(o, t, n);
                int ai = WorldRenderer.getLightmapCoordinates(world, mutable);
                int aj = ai >> 16 & (LightmapTextureManager.MAX_BLOCK_LIGHT_COORDINATE | 0xFF0F);
                ac = ai & (LightmapTextureManager.MAX_BLOCK_LIGHT_COORDINATE | 0xFF0F);
                ...
                bufferBuilder.vertex((float)((double)o - cameraX - d + 0.5), (float)((double)s - cameraY), (float)((double)n - cameraZ - e + 0.5)).texture(0.0f + ae, (float)r * 0.25f + ad + h).color(1.0f, 1.0f, 1.0f, ah).light(al, ak);
                bufferBuilder.vertex((float)((double)o - cameraX + d + 0.5), (float)((double)s - cameraY), (float)((double)n - cameraZ + e + 0.5)).texture(1.0f + ae, (float)r * 0.25f + ad + h).color(1.0f, 1.0f, 1.0f, ah).light(al, ak);
                bufferBuilder.vertex((float)((double)o - cameraX + d + 0.5), (float)((double)r - cameraY), (float)((double)n - cameraZ + e + 0.5)).texture(1.0f + ae, (float)s * 0.25f + ad + h).color(1.0f, 1.0f, 1.0f, ah).light(al, ak);
                bufferBuilder.vertex((float)((double)o - cameraX - d + 0.5), (float)((double)r - cameraY), (float)((double)n - cameraZ - e + 0.5)).texture(0.0f + ae, (float)s * 0.25f + ad + h).color(1.0f, 1.0f, 1.0f, ah).light(al, ak);
            }
        }
        if (m >= 0) {
            BufferRenderer.drawWithGlobalProgram(bufferBuilder.end());
    ...
    private void loadTransparencyPostProcessor() {
        ...
        try {
            ...
            if (this.client.getResourcePackManager().getEnabledIds().size() > 1) {
                Text text = this.client.getResourceManager().streamResourcePacks().findFirst().map(resourcePack -> Text.literal(resourcePack.getId())).orElse(null);
    ...
    private static BuiltBuffer renderSky(Tessellator tessellator, float f) {
        ...
        for (int i = -180; i <= 180; i += 45) {
            bufferBuilder.vertex(g * MathHelper.cos((float)i * ((float)Math.PI / 180)), f, 512.0f * MathHelper.sin((float)i * ((float)Math.PI / 180)));
        }
    ...
    public void render(RenderTickCounter tickCounter, boolean renderBlockOutline, Camera camera, GameRenderer gameRenderer, LightmapTextureManager lightmapTextureManager, Matrix4f matrix4f, Matrix4f matrix4f2) {
        ...
        this.renderSky(matrix4f, matrix4f2, f, camera, bl22, () -> BackgroundRenderer.applyFog(camera, BackgroundRenderer.FogType.FOG_SKY, h, bl22, f));
        profiler.swap("fog");
        BackgroundRenderer.applyFog(camera, BackgroundRenderer.FogType.FOG_TERRAIN, Math.max(h, 32.0f), bl22, f);
        ...
        for (Entity entity : this.world.getEntities()) {
            ...
            this.renderEntity(entity, d, e, g, j, matrixStack, (VertexConsumerProvider)vertexConsumerProvider);
        }
        ...
        for (ChunkBuilder.BuiltChunk builtChunk : this.builtChunks) {
            ...
            for (BlockEntity blockEntity : list) {
                ...
                if (sortedSet != null && !sortedSet.isEmpty() && (k = ((BlockBreakingInfo)sortedSet.last()).getStage()) >= 0) {
                    ...
                    OverlayVertexConsumer vertexConsumer = new OverlayVertexConsumer(this.bufferBuilders.getEffectVertexConsumers().getBuffer(ModelLoader.BLOCK_DESTRUCTION_RENDER_LAYERS.get(k)), entry, 1.0f);
        ...
        for (Long2ObjectMap.Entry entry : this.blockBreakingProgressions.long2ObjectEntrySet()) {
            ...
            if (l * l + (m = (double)blockPos.getY() - e) * m + (n = (double)blockPos.getZ() - g) * n > 1024.0 || (sortedSet2 = (SortedSet)entry.getValue()) == null || sortedSet2.isEmpty()) continue;
            ...
            OverlayVertexConsumer vertexConsumer2 = new OverlayVertexConsumer(this.bufferBuilders.getEffectVertexConsumers().getBuffer(ModelLoader.BLOCK_DESTRUCTION_RENDER_LAYERS.get(o)), entry3, 1.0f);
        ...
        if (renderBlockOutline && hitResult != null && hitResult.getType() == HitResult.Type.BLOCK) {
            ...
            if (!blockState.isAir() && this.world.getWorldBorder().contains(blockPos2)) {
                ...
                this.drawBlockOutline(matrixStack, vertexConsumer3, camera.getFocusedEntity(), d, e, g, blockPos2, blockState);
            }
        }
    ...
    private void renderLayer(RenderLayer renderLayer, double x, double y, double z, Matrix4f matrix4f, Matrix4f positionMatrix) {
        ...
        if (renderLayer == RenderLayer.getTranslucent()) {
            ...
            if (d * d + e * e + f * f > 1.0) {
                ...
                int l = 0;
                for (ChunkBuilder.BuiltChunk builtChunk : this.builtChunks) {
                    if (l >= 15 || !bl && !builtChunk.method_52841(i, j, k) || !builtChunk.scheduleSort(renderLayer, this.chunkBuilder)) continue;
                    ++l;
                }
            }
            this.client.getProfiler().pop();
        ...
        while (bl2 ? objectListIterator.hasNext() : objectListIterator.hasPrevious()) {
            ...
            ChunkBuilder.BuiltChunk builtChunk = builtChunk2 = bl2 ? (ChunkBuilder.BuiltChunk)objectListIterator.next() : (ChunkBuilder.BuiltChunk)objectListIterator.previous();
            if (builtChunk2.getData().isEmpty(renderLayer)) continue;
    ...
    public void renderClouds(MatrixStack matrices, Matrix4f matrix4f, Matrix4f matrix4f2, float tickDelta, double cameraX, double cameraY, double cameraZ) {
        ...
        if (this.cloudsBuffer != null) {
            int r;
            this.cloudsBuffer.bind();
            for (int s = r = this.lastCloudRenderMode == CloudRenderMode.FANCY ? 0 : 1; s < 2; ++s) {
        ...
        if (this.lastCloudRenderMode == CloudRenderMode.FANCY) {
            ...
            for (int ah = -32; ah < 32; ah += 32) {
                for (int ai = -32; ai < 32; ai += 32) {
                    bufferBuilder.vertex(ah + 0, ab, ai + 32).texture((float)(ah + 0) * 0.00390625f + k, (float)(ai + 32) * 0.00390625f + l).color(m, n, o, 0.8f).normal(0.0f, -1.0f, 0.0f);
                    bufferBuilder.vertex(ah + 32, ab, ai + 32).texture((float)(ah + 32) * 0.00390625f + k, (float)(ai + 32) * 0.00390625f + l).color(m, n, o, 0.8f).normal(0.0f, -1.0f, 0.0f);
                    bufferBuilder.vertex(ah + 32, ab, ai + 0).texture((float)(ah + 32) * 0.00390625f + k, (float)(ai + 0) * 0.00390625f + l).color(m, n, o, 0.8f).normal(0.0f, -1.0f, 0.0f);
                    bufferBuilder.vertex(ah + 0, ab, ai + 0).texture((float)(ah + 0) * 0.00390625f + k, (float)(ai + 0) * 0.00390625f + l).color(m, n, o, 0.8f).normal(0.0f, -1.0f, 0.0f);
                }
            }
        }
        return bufferBuilder.end();
    ...
    private void renderWorldBorder(Camera camera) {
        ...
        if ((builtBuffer = bufferBuilder.endNullable()) != null) {
    ...
    private static Vec3d shiftHue(float red, float green, float blue, float hueOffset) {
        Vec3d vec3d = WorldRenderer.getMaxIntensityColor(hueOffset).multiply(red);
        Vec3d vec3d2 = WorldRenderer.getMaxIntensityColor((hueOffset + 0.33333334f) % 1.0f).multiply(green);
        Vec3d vec3d3 = WorldRenderer.getMaxIntensityColor((hueOffset + 0.6666667f) % 1.0f).multiply(blue);
    ...
    public static void drawShapeOutline(MatrixStack matrices, VertexConsumer vertexConsumer, VoxelShape shape, double offsetX, double offsetY, double offsetZ, float red, float green, float blue, float alpha, boolean colorize) {
        ...
        for (int j = 1; j < list.size(); ++j) {
            ...
            Vec3d vec3d = WorldRenderer.shiftHue(red, green, blue, f);
            WorldRenderer.drawCuboidShapeOutline(matrices, vertexConsumer, VoxelShapes.cuboid(box), offsetX, offsetY, offsetZ, (float)vec3d.x, (float)vec3d.y, (float)vec3d.z, alpha);
        }
    }
    ...
    private static void drawCuboidShapeOutline(MatrixStack matrices, VertexConsumer vertexConsumer, VoxelShape shape, double offsetX, double offsetY, double offsetZ, float red, float green, float blue, float alpha) {
        ...
        shape.forEachEdge((minX, minY, minZ, maxX, maxY, maxZ) -> {
            ...
            vertexConsumer.vertex(entry, (float)(minX + offsetX), (float)(minY + offsetY), (float)(minZ + offsetZ)).color(red, green, blue, alpha).normal(entry, k /= n, l /= n, m /= n);
    ...
    public void processWorldEvent(int eventId, BlockPos pos, int data) {
        ...
        switch (eventId) {
            ...
            case 2007: {
                ...
                SimpleParticleType particleEffect = eventId == 2007 ? ParticleTypes.INSTANT_EFFECT : ParticleTypes.EFFECT;
                for (int m = 0; m < 100; ++m) {
            ...
            case 3006: {
                ...
                if (s > 0) {
                    ...
                    for (int ac = 0; ac < aa; ++ac) {
                        ...
                        this.world.addParticle(ParticleTypes.SCULK_CHARGE_POP, (double)pos.getX() + 0.5 + (double)(ad * x), (double)pos.getY() + 0.5 + (double)(z * x), (double)pos.getZ() + 0.5 + (double)(ae * x), ad * 0.07f, z * 0.07f, ae * 0.07f);
                    }
                }
                break;
            }
            case 3007: {
                ...
                for (int af = 0; af < 10; ++af) {
                    this.world.addParticle(new ShriekParticleEffect(af * 5), false, (double)pos.getX() + 0.5, (double)pos.getY() + SculkShriekerBlock.TOP, (double)pos.getZ() + 0.5, 0.0, 0.0, 0.0);
                }
            ...
            case 1010: {
                this.world.getRegistryManager().get(RegistryKeys.JUKEBOX_SONG).getEntry(data).ifPresent(reference -> this.playJukeboxSong((RegistryEntry<JukeboxSong>)reference, pos));
                break;
            }
            case 1011: {
