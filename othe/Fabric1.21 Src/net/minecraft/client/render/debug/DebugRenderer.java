...
public class DebugRenderer {
    ...
    public static Optional<Entity> getTargetedEntity(@Nullable Entity entity, int maxDistance) {
        ...
        EntityHitResult entityHitResult = ProjectileUtil.raycast(entity, vec3d, vec3d3 = vec3d.add(vec3d2 = entity.getRotationVec(1.0f).multiply(maxDistance)), box = entity.getBoundingBox().stretch(vec3d2).expand(1.0), predicate = entityx -> !entityx.isSpectator() && entityx.canHit(), i = maxDistance * maxDistance);
