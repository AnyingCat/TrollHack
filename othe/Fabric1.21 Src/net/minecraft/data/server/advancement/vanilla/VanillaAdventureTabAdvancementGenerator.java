...
implements AdvancementTabGenerator {
    ...
    public void accept(RegistryWrapper.WrapperLookup lookup, Consumer<AdvancementEntry> exporter) {
        ...
        VanillaAdventureTabAdvancementGenerator.buildAdventuringTime(lookup, exporter, advancementEntry2, MultiNoiseBiomeSourceParameterList.Preset.OVERWORLD);
        ...
        AdvancementEntry advancementEntry4 = VanillaAdventureTabAdvancementGenerator.createKillMobAdvancements(advancementEntry, exporter, MONSTERS);
        ...
        Advancement.Builder.create().parent(advancementEntry4).display(Items.TOTEM_OF_UNDYING, (Text)Text.translatable("advancements.adventure.totem_of_undying.title"), (Text)Text.translatable("advancements.adventure.totem_of_undying.description"), null, AdvancementFrame.GOAL, true, true, false).criterion("used_totem", UsedTotemCriterion.Conditions.create(Items.TOTEM_OF_UNDYING)).build(exporter, "adventure/totem_of_undying");
        ...
        Advancement.Builder.create().parent(advancementEntry7).display(Items.CROSSBOW, (Text)Text.translatable("advancements.adventure.whos_the_pillager_now.title"), (Text)Text.translatable("advancements.adventure.whos_the_pillager_now.description"), null, AdvancementFrame.TASK, true, true, false).criterion("kill_pillager", KilledByCrossbowCriterion.Conditions.create(EntityPredicate.Builder.create().type(EntityType.PILLAGER))).build(exporter, "adventure/whos_the_pillager_now");
        ...
        AdvancementEntry advancementEntry8 = Advancement.Builder.create().parent(advancementEntry).display(Raid.getOminousBanner(impl), (Text)Text.translatable("advancements.adventure.voluntary_exile.title"), (Text)Text.translatable("advancements.adventure.voluntary_exile.description"), null, AdvancementFrame.TASK, true, true, true).criterion("voluntary_exile", OnKilledCriterion.Conditions.createPlayerKilledEntity(EntityPredicate.Builder.create().type(EntityTypeTags.RAIDERS).equipment(EntityEquipmentPredicate.ominousBannerOnHead(impl)))).build(exporter, "adventure/voluntary_exile");
        Advancement.Builder.create().parent(advancementEntry8).display(Raid.getOminousBanner(impl), (Text)Text.translatable("advancements.adventure.hero_of_the_village.title"), (Text)Text.translatable("advancements.adventure.hero_of_the_village.description"), null, AdvancementFrame.CHALLENGE, true, true, true).rewards(AdvancementRewards.Builder.experience(100)).criterion("hero_of_the_village", TickCriterion.Conditions.createHeroOfTheVillage()).build(exporter, "adventure/hero_of_the_village");
        ...
        AdvancementEntry advancementEntry11 = VanillaAdventureTabAdvancementGenerator.requireSalvagedSherd(Advancement.Builder.create()).parent(advancementEntry).display(Items.BRUSH, (Text)Text.translatable("advancements.adventure.salvage_sherd.title"), (Text)Text.translatable("advancements.adventure.salvage_sherd.description"), null, AdvancementFrame.TASK, true, true, false).build(exporter, "adventure/salvage_sherd");
        Advancement.Builder.create().parent(advancementEntry11).display(DecoratedPotBlockEntity.getStackWith(new Sherds(Optional.empty(), Optional.of(Items.HEART_POTTERY_SHERD), Optional.empty(), Optional.of(Items.EXPLORER_POTTERY_SHERD))), (Text)Text.translatable("advancements.adventure.craft_decorated_pot_using_only_sherds.title"), (Text)Text.translatable("advancements.adventure.craft_decorated_pot_using_only_sherds.description"), null, AdvancementFrame.TASK, true, true, false).criterion("pot_crafted_using_only_sherds", RecipeCraftedCriterion.Conditions.create(Identifier.ofVanilla("decorated_pot"), List.of(ItemPredicate.Builder.create().tag(ItemTags.DECORATED_POT_SHERDS), ItemPredicate.Builder.create().tag(ItemTags.DECORATED_POT_SHERDS), ItemPredicate.Builder.create().tag(ItemTags.DECORATED_POT_SHERDS), ItemPredicate.Builder.create().tag(ItemTags.DECORATED_POT_SHERDS)))).build(exporter, "adventure/craft_decorated_pot_using_only_sherds");
        ...
        Advancement.Builder.create().parent(advancementEntry).display(Items.CHISELED_BOOKSHELF, (Text)Text.translatable("advancements.adventure.read_power_from_chiseled_bookshelf.title"), (Text)Text.translatable("advancements.adventure.read_power_from_chiseled_bookshelf.description"), null, AdvancementFrame.TASK, true, true, false).criteriaMerger(AdvancementRequirements.CriterionMerger.OR).criterion("chiseled_bookshelf", VanillaAdventureTabAdvancementGenerator.requirePlacedBlockReadByComparator(Blocks.CHISELED_BOOKSHELF)).criterion("comparator", VanillaAdventureTabAdvancementGenerator.requirePlacedComparatorReadingBlock(Blocks.CHISELED_BOOKSHELF)).build(exporter, "adventure/read_power_of_chiseled_bookshelf");
        ...
        Advancement.Builder.create().parent(advancementEntry13).display(Items.WIND_CHARGE, (Text)Text.translatable("advancements.adventure.who_needs_rockets.title"), (Text)Text.translatable("advancements.adventure.who_needs_rockets.description"), null, AdvancementFrame.TASK, true, true, false).criterion("who_needs_rockets", FallAfterExplosionCriterion.Conditions.create(DistancePredicate.y(NumberRange.DoubleRange.atLeast(7.0)), EntityPredicate.Builder.create().type(EntityType.WIND_CHARGE))).build(exporter, "adventure/who_needs_rockets");
    ...
    private static AdvancementCriterion<ItemCriterion.Conditions> requirePlacedComparatorReadingBlock(Block block) {
        LootCondition.Builder[] builders = (LootCondition.Builder[])ComparatorBlock.FACING.getValues().stream().map(facing -> {
            ...
            LootCondition.Builder builder3 = LocationCheckLootCondition.builder(LocationPredicate.Builder.create().block(BlockPredicate.Builder.create().blocks(block)), new BlockPos(facing.getVector()));
    ...
    protected static Advancement.Builder requireListedBiomesVisited(Advancement.Builder builder, RegistryWrapper.WrapperLookup registryLookup, List<RegistryKey<Biome>> biomes) {
        RegistryWrapper.Impl<Biome> registryEntryLookup = registryLookup.getWrapperOrThrow(RegistryKeys.BIOME);
