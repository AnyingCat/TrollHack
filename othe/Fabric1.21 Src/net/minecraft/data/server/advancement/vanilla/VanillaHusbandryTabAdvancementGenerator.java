...
implements AdvancementTabGenerator {
    ...
    public void accept(RegistryWrapper.WrapperLookup lookup, Consumer<AdvancementEntry> exporter) {
        ...
        AdvancementEntry advancementEntry = Advancement.Builder.create().display(Blocks.HAY_BLOCK, (Text)Text.translatable("advancements.husbandry.root.title"), (Text)Text.translatable("advancements.husbandry.root.description"), Identifier.ofVanilla("textures/gui/advancements/backgrounds/husbandry.png"), AdvancementFrame.TASK, false, false, false).criterion("consumed_item", ConsumeItemCriterion.Conditions.any()).build(exporter, "husbandry/root");
        ...
        VanillaHusbandryTabAdvancementGenerator.createBreedAllAnimalsAdvancement(advancementEntry3, exporter, BREEDABLE_ANIMALS.stream(), EGG_LAYING_ANIMALS.stream());
        VanillaHusbandryTabAdvancementGenerator.requireFoodItemsEaten(Advancement.Builder.create()).parent(advancementEntry2).display(Items.APPLE, (Text)Text.translatable("advancements.husbandry.balanced_diet.title"), (Text)Text.translatable("advancements.husbandry.balanced_diet.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(100)).build(exporter, "husbandry/balanced_diet");
        ...
        AdvancementEntry advancementEntry5 = VanillaHusbandryTabAdvancementGenerator.requireListedFishCaught(Advancement.Builder.create()).parent(advancementEntry).criteriaMerger(AdvancementRequirements.CriterionMerger.OR).display(Items.FISHING_ROD, (Text)Text.translatable("advancements.husbandry.fishy_business.title"), (Text)Text.translatable("advancements.husbandry.fishy_business.description"), null, AdvancementFrame.TASK, true, true, false).build(exporter, "husbandry/fishy_business");
        AdvancementEntry advancementEntry6 = VanillaHusbandryTabAdvancementGenerator.requireListedFishBucketsFilled(Advancement.Builder.create()).parent(advancementEntry5).criteriaMerger(AdvancementRequirements.CriterionMerger.OR).display(Items.PUFFERFISH_BUCKET, (Text)Text.translatable("advancements.husbandry.tactical_fishing.title"), (Text)Text.translatable("advancements.husbandry.tactical_fishing.description"), null, AdvancementFrame.TASK, true, true, false).build(exporter, "husbandry/tactical_fishing");
        ...
        VanillaHusbandryTabAdvancementGenerator.requireAllCatsTamed(Advancement.Builder.create()).parent(advancementEntry4).display(Items.COD, (Text)Text.translatable("advancements.husbandry.complete_catalogue.title"), (Text)Text.translatable("advancements.husbandry.complete_catalogue.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).build(exporter, "husbandry/complete_catalogue");
        VanillaHusbandryTabAdvancementGenerator.requireAllWolvesTamed(Advancement.Builder.create(), lookup).parent(advancementEntry4).display(Items.BONE, (Text)Text.translatable("advancements.husbandry.whole_pack.title"), (Text)Text.translatable("advancements.husbandry.whole_pack.description"), null, AdvancementFrame.CHALLENGE, true, true, false).rewards(AdvancementRewards.Builder.experience(50)).build(exporter, "husbandry/whole_pack");
        ...
        Advancement.Builder.create().parent(advancementEntry).criterion("silk_touch_nest", BeeNestDestroyedCriterion.Conditions.create(Blocks.BEE_NEST, ItemPredicate.Builder.create().subPredicate(ItemSubPredicateTypes.ENCHANTMENTS, EnchantmentsPredicate.enchantments(List.of(new EnchantmentPredicate(impl.getOrThrow(Enchantments.SILK_TOUCH), NumberRange.IntRange.atLeast(1))))), NumberRange.IntRange.exactly(3))).display(Blocks.BEE_NEST, (Text)Text.translatable("advancements.husbandry.silk_touch_nest.title"), (Text)Text.translatable("advancements.husbandry.silk_touch_nest.description"), null, AdvancementFrame.TASK, true, true, false).build(exporter, "husbandry/silk_touch_nest");
        ...
        AdvancementEntry advancementEntry14 = Advancement.Builder.create().parent(advancementEntry13).display(Items.TORCHFLOWER_SEEDS, (Text)Text.translatable("advancements.husbandry.feed_snifflet.title"), (Text)Text.translatable("advancements.husbandry.feed_snifflet.description"), null, AdvancementFrame.TASK, true, true, true).criterion("feed_snifflet", PlayerInteractedWithEntityCriterion.Conditions.create(ItemPredicate.Builder.create().tag(ItemTags.SNIFFER_FOOD), Optional.of(EntityPredicate.contextPredicateFromEntityPredicate(EntityPredicate.Builder.create().type(EntityType.SNIFFER).flags(EntityFlagsPredicate.Builder.create().isBaby(true)))))).build(exporter, "husbandry/feed_snifflet");
    ...
    private static Advancement.Builder requireListedFishCaught(Advancement.Builder builder) {
        for (Item item : FISH_ITEMS) {
            builder.criterion(Registries.ITEM.getId(item).getPath(), FishingRodHookedCriterion.Conditions.create(Optional.empty(), Optional.empty(), Optional.of(ItemPredicate.Builder.create().items(item).build())));
        }
        return builder;
    }
    ...
    private static Advancement.Builder requireAllWolvesTamed(Advancement.Builder builder, RegistryWrapper.WrapperLookup registryLookup) {
        ...
        impl.streamKeys().sorted(Comparator.comparing(RegistryKey::getValue)).forEach(key -> {
            RegistryEntry.Reference registryEntry = impl.getOrThrow((RegistryKey<WolfVariant>)key);
            builder.criterion(key.getValue().toString(), TameAnimalCriterion.Conditions.create(EntityPredicate.Builder.create().typeSpecific(EntitySubPredicateTypes.wolfVariant(RegistryEntryList.of(registryEntry)))));
        });
        return builder;
    }
}
