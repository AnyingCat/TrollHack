...
extends BlockLootTableGenerator {
    ...
    protected void generate() {
        ...
        this.addDrop(Blocks.NETHER_GOLD_ORE, (Block block) -> this.dropsWithSilkTouch((Block)block, (LootPoolEntry.Builder)this.applyExplosionDecay((ItemConvertible)block, ((LeafEntry.Builder)ItemEntry.builder(Items.GOLD_NUGGET).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0f, 6.0f)))).apply(ApplyBonusLootFunction.oreDrops(impl.getOrThrow(Enchantments.FORTUNE))))));
        ...
        this.addDrop(Blocks.GRAVEL, (Block block) -> this.dropsWithSilkTouch((Block)block, this.addSurvivesExplosionCondition((ItemConvertible)block, ((LeafEntry.Builder)ItemEntry.builder(Items.FLINT).conditionally(TableBonusLootCondition.builder(impl.getOrThrow(Enchantments.FORTUNE), 0.1f, 0.14285715f, 0.25f, 1.0f))).alternatively(ItemEntry.builder(block)))));
        ...
        this.addDrop(Blocks.GILDED_BLACKSTONE, (Block block) -> this.dropsWithSilkTouch((Block)block, this.addSurvivesExplosionCondition((ItemConvertible)block, ((LeafEntry.Builder)((LootPoolEntry.Builder)((Object)ItemEntry.builder(Items.GOLD_NUGGET).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(2.0f, 5.0f))))).conditionally(TableBonusLootCondition.builder(impl.getOrThrow(Enchantments.FORTUNE), 0.1f, 0.14285715f, 0.25f, 1.0f))).alternatively(ItemEntry.builder(block)))));
        ...
        this.addDrop(Blocks.AMETHYST_CLUSTER, (Block block) -> this.dropsWithSilkTouch((Block)block, ((LeafEntry.Builder)((LootPoolEntry.Builder)((Object)((LeafEntry.Builder)ItemEntry.builder(Items.AMETHYST_SHARD).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(4.0f)))).apply(ApplyBonusLootFunction.oreDrops(impl.getOrThrow(Enchantments.FORTUNE))))).conditionally(MatchToolLootCondition.builder(ItemPredicate.Builder.create().tag(ItemTags.CLUSTER_MAX_HARVESTABLES)))).alternatively((LootPoolEntry.Builder)this.applyExplosionDecay((ItemConvertible)block, ItemEntry.builder(Items.AMETHYST_SHARD).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(2.0f)))))));
