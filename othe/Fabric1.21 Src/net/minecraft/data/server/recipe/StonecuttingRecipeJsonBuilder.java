...
implements CraftingRecipeJsonBuilder {
    ...
    public void offerTo(RecipeExporter exporter, Identifier recipeId) {
        ...
        Object cuttingRecipe = this.recipeFactory.create(Objects.requireNonNullElse(this.group, ""), this.input, new ItemStack(this.output, this.count));
        exporter.accept(recipeId, (Recipe<?>)cuttingRecipe, builder.build(recipeId.withPrefixedPath("recipes/" + this.category.getName() + "/")));
    }
