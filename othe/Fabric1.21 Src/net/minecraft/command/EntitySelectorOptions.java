    ...
    public static void register() {
        ...
        EntitySelectorOptions.putOption("nbt", reader -> {
            ...
            reader.addPredicate(entity -> {
                ...
                if (entity instanceof ServerPlayerEntity && !(itemStack = (serverPlayerEntity = (ServerPlayerEntity)entity).getInventory().getMainHandStack()).isEmpty()) {
        ...
        EntitySelectorOptions.putOption("predicate", reader -> {
            ...
            reader.addPredicate(entity -> {
                ...
                LootContextParameterSet lootContextParameterSet = new LootContextParameterSet.Builder(serverWorld).add(LootContextParameters.THIS_ENTITY, entity).add(LootContextParameters.ORIGIN, entity.getPos()).build(LootContextTypes.SELECTOR);
