    ...
    public void run() {
        while (this.server.isRunning()) {
            ...
            if (n > this.maxTickTime) {
                ...
                crashReportSection2.add("Level stats", () -> Streams.stream(this.server.getWorlds()).map(world -> String.valueOf(world.getRegistryKey()) + ": " + world.getDebugString()).collect(Collectors.joining(",\n")));
