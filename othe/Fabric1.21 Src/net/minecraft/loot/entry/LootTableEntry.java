    ...
    public void validate(LootTableReporter reporter) {
        ...
        if (optional.isPresent()) {
            ...
            if (!reporter.canUseReferences()) {
                reporter.report("Uses reference to " + String.valueOf(registryKey.getValue()) + ", but references are not allowed");
                return;
            }
            if (reporter.isInStack(registryKey)) {
                reporter.report("Table " + String.valueOf(registryKey.getValue()) + " is recursively called");
                return;
            }
        }
