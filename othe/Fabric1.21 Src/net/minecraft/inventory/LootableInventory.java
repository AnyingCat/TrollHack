...
extends Inventory {
    ...
    default public boolean writeLootTable(NbtCompound nbt) {
        ...
        nbt.putString(LOOT_TABLE_KEY, registryKey.getValue().toString());
    ...
    default public void generateLoot(@Nullable PlayerEntity player) {
        ...
        if (registryKey != null && world != null && world.getServer() != null) {
            ...
            LootContextParameterSet.Builder builder = new LootContextParameterSet.Builder((ServerWorld)world).add(LootContextParameters.ORIGIN, Vec3d.ofCenter(blockPos));
            if (player != null) {
