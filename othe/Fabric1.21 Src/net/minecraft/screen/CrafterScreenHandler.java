...
implements ScreenHandlerListener {
    ...
    private void updateResult() {
        ...
        if (playerEntity instanceof ServerPlayerEntity) {
            ...
            ItemStack itemStack = CrafterBlock.getCraftingRecipe(world, craftingRecipeInput).map(recipeEntry -> ((CraftingRecipe)recipeEntry.value()).craft(craftingRecipeInput, world.getRegistryManager())).orElse(ItemStack.EMPTY);
