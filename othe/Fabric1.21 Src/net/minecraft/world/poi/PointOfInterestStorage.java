...
extends SerializingRegionBasedStorage<PointOfInterestSet> {
    ...
    public PointOfInterestStorage(StorageKey storageKey, Path directory, DataFixer dataFixer, boolean dsync, DynamicRegistryManager registryManager, ChunkErrorHandler errorHandler, HeightLimitView world) {
        super(new ChunkPosKeyedStorage(storageKey, directory, dataFixer, dsync, DataFixTypes.POI_CHUNK), PointOfInterestSet::createCodec, PointOfInterestSet::new, registryManager, errorHandler, world);
