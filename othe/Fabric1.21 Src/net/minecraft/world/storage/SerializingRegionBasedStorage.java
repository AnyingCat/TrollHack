...
implements AutoCloseable {
    ...
    public SerializingRegionBasedStorage(ChunkPosKeyedStorage storageAccess, Function<Runnable, Codec<R>> codecFactory, Function<Runnable, R> factory, DynamicRegistryManager registryManager, ChunkErrorHandler errorHandler, HeightLimitView world) {
