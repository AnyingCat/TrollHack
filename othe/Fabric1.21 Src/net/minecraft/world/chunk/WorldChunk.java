...
extends Chunk {
    ...
    public GameEventDispatcher getGameEventDispatcher(int ySectionCoord) {
        ...
        if (world instanceof ServerWorld) {
            ...
            return this.gameEventDispatchers.computeIfAbsent(ySectionCoord, sectionCoord -> new SimpleGameEventDispatcher(serverWorld, ySectionCoord, this::removeGameEventDispatcher));
        }
    ...
    private <T extends BlockEntity> void updateTicker(T blockEntity) {
        ...
        if (blockEntityTicker == null) {
            ...
            this.blockEntityTickers.compute(blockEntity.getPos(), (pos, ticker) -> {
                ...
                if (this.canTickBlockEntities()) {
                    WrappedBlockEntityTickInvoker wrappedBlockEntityTickInvoker = new WrappedBlockEntityTickInvoker(this, blockEntityTickInvoker);
    ...
    implements BlockEntityTickInvoker {
        ...
        WrappedBlockEntityTickInvoker(WorldChunk worldChunk, BlockEntityTickInvoker wrapped) {
