...
AutoCloseable {
    ...
    public void playSound(@Nullable Entity source, BlockPos pos, SoundEvent sound, SoundCategory category, float volume, float pitch) {
        ...
        this.playSound(source instanceof PlayerEntity ? (playerEntity = (PlayerEntity)source) : null, pos, sound, category, volume, pitch);
    }
    ...
    public CrashReportSection addDetailsToCrashReport(CrashReport report) {
        ...
        crashReportSection.add("All players", () -> this.getPlayers().size() + " total; " + String.valueOf(this.getPlayers()));
