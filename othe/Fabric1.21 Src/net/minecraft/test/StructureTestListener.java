...
implements TestListener {
    ...
    public void onFailed(GameTestState test, TestRunContext context) {
        ...
        String string = "Flaky test " + String.valueOf(test) + " failed, attempt: " + this.attempt + "/" + testFunction.maxAttempts();
    ...
    protected static void visualizeTest(GameTestState test, Block block) {
        ...
        BlockPos blockPos = StructureTestListener.getBeaconPos(test);
    ...
    private static void placeAboveBeacon(GameTestState state, Block block) {
        ...
        if (serverWorld.getBlockState(blockPos = StructureTestListener.getBeaconPos(state)).isOf(Blocks.BEACON)) {
    ...
    private static ItemStack createBookWithText(String text, boolean required, String output) {
        ...
        itemStack.set(DataComponentTypes.WRITABLE_BOOK_CONTENT, new WritableBookContentComponent(List.of(RawFilteredPair.of(String.valueOf(stringBuffer) + output))));
        return itemStack;
    }
