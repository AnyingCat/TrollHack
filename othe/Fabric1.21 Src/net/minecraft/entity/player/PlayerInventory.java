...
Nameable {
    ...
    public int indexOf(ItemStack stack) {
        for (int i = 0; i < this.main.size(); ++i) {
            ...
            if (itemStack.isEmpty() || !ItemStack.areItemsAndComponentsEqual(stack, itemStack) || itemStack.isDamaged() || itemStack.hasEnchantments() || itemStack.contains(DataComponentTypes.CUSTOM_NAME)) continue;
            return i;
        }
        return -1;
    }
