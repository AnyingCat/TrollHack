...
extends Entity {
    ...
    private void spawnItem() {
        ...
        if (item instanceof ProjectileItem) {
            ...
            projectileItem.initializeProjectile(projectileEntity, direction.getOffsetX(), direction.getOffsetY(), direction.getOffsetZ(), settings.power(), settings.uncertainty());
    ...
    protected void readCustomDataFromNbt(NbtCompound nbt) {
        ItemStack itemStack = nbt.contains(ITEM_NBT_KEY, NbtElement.COMPOUND_TYPE) ? ItemStack.fromNbt(this.getRegistryManager(), nbt.getCompound(ITEM_NBT_KEY)).orElse(ItemStack.EMPTY) : ItemStack.EMPTY;
