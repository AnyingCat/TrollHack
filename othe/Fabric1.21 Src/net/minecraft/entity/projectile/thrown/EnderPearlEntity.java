    ...
    protected void onCollision(HitResult hitResult) {
        ...
        if (entity instanceof ServerPlayerEntity) {
            ...
            if (serverPlayerEntity.networkHandler.isConnectionOpen()) {
                ...
                if (this.random.nextFloat() < 0.05f && serverWorld.getGameRules().getBoolean(GameRules.DO_MOB_SPAWNING) && (endermiteEntity = EntityType.ENDERMITE.create(serverWorld)) != null) {
