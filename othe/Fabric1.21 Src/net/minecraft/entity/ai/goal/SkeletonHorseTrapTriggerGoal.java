...
extends Goal {
    ...
    private AbstractHorseEntity getHorse(LocalDifficulty localDifficulty) {
        SkeletonHorseEntity skeletonHorseEntity = EntityType.SKELETON_HORSE.create((World)this.skeletonHorse.getWorld());
    ...
    private SkeletonEntity getSkeleton(LocalDifficulty localDifficulty, AbstractHorseEntity vehicle) {
        SkeletonEntity skeletonEntity = EntityType.SKELETON.create((World)vehicle.getWorld());
        if (skeletonEntity != null) {
