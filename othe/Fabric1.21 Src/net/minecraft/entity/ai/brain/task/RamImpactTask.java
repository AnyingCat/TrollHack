...
extends MultiTickTask<GoatEntity> {
    ...
    protected void keepRunning(ServerWorld serverWorld, GoatEntity goatEntity, long l) {
        ...
        if (!list.isEmpty()) {
            ...
            if (livingEntity.damage(damageSource = serverWorld.getDamageSources().mobAttackNoAggro(goatEntity), (float)goatEntity.getAttributeValue(EntityAttributes.GENERIC_ATTACK_DAMAGE))) {
