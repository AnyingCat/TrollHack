...
implements VariantHolder<RegistryEntry<PaintingVariant>> {
    ...
    public void writeCustomDataToNbt(NbtCompound nbt) {
        VARIANT_ENTRY_CODEC.encodeStart(this.getRegistryManager().getOps(NbtOps.INSTANCE), (RegistryEntry<PaintingVariant>)this.getVariant()).ifSuccess(nbtElement -> nbt.copyFrom((NbtCompound)nbtElement));
