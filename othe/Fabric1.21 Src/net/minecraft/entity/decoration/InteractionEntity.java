...
Targeter {
    ...
    protected void writeCustomDataToNbt(NbtCompound nbt) {
        ...
        if (this.attack != null) {
            Interaction.CODEC.encodeStart(NbtOps.INSTANCE, this.attack).ifSuccess(nbtElement -> nbt.put(ATTACK_KEY, (NbtElement)nbtElement));
        }
        if (this.interaction != null) {
            Interaction.CODEC.encodeStart(NbtOps.INSTANCE, this.interaction).ifSuccess(nbtElement -> nbt.put(INTERACTION_KEY, (NbtElement)nbtElement));
        }
