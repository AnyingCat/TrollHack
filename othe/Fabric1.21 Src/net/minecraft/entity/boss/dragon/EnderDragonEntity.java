...
implements Monster {
    ...
    public void tickMovement() {
        ...
        if (this.fight == null && (world = this.getWorld()) instanceof ServerWorld && (enderDragonFight = (serverWorld = (ServerWorld)world).getEnderDragonFight()) != null && this.getUuid().equals(enderDragonFight.getDragonUuid())) {
        ...
        if (k instanceof ServerWorld) {
            ServerWorld serverWorld2 = (ServerWorld)k;
            if (this.hurtTime == 0) {
                this.launchLivingEntities(serverWorld2, serverWorld2.getOtherEntities(this, this.rightWing.getBoundingBox().expand(4.0, 2.0, 4.0).offset(0.0, -2.0, 0.0), EntityPredicates.EXCEPT_CREATIVE_OR_SPECTATOR));
                this.launchLivingEntities(serverWorld2, serverWorld2.getOtherEntities(this, this.leftWing.getBoundingBox().expand(4.0, 2.0, 4.0).offset(0.0, -2.0, 0.0), EntityPredicates.EXCEPT_CREATIVE_OR_SPECTATOR));
        ...
        for (ab = 0; ab < 3; ++ab) {
            ...
            this.movePart(enderDragonPart, -(w * 1.5f + n * ad) * t, es[1] - ds[1] - (double)((ad + 1.5f) * u) + 1.5, (x * 1.5f + o * ad) * t);
        }
        if (!this.getWorld().isClient) {
