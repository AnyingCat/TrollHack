...
VehicleInventory {
    ...
    public ChestBoatEntity(World world, double d, double e, double f) {
        super((EntityType<? extends BoatEntity>)EntityType.CHEST_BOAT, world);
    ...
    public ActionResult interact(PlayerEntity player, Hand hand) {
        ...
        if (!player.shouldCancelInteraction() && (actionResult = super.interact(player, hand)) != ActionResult.PASS) {
            return actionResult;
        }
