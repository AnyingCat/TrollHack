...
extends SpecialCraftingRecipe {
    ...
    public ItemStack craft(CraftingRecipeInput craftingRecipeInput, RegistryWrapper.WrapperLookup wrapperLookup) {
        ...
        EnchantmentHelper.apply(itemStack3, builder -> wrapperLookup.getWrapperOrThrow(RegistryKeys.ENCHANTMENT).streamEntries().filter(enchantment -> enchantment.isIn(EnchantmentTags.CURSE)).forEach(enchantment -> {
