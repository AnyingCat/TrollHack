...
implements CraftingRecipe {
    ...
    public boolean matches(CraftingRecipeInput craftingRecipeInput, World world) {
        ...
        if (craftingRecipeInput.getSize() == 1 && this.ingredients.size() == 1) {
            return ((Ingredient)this.ingredients.getFirst()).test(craftingRecipeInput.getStackInSlot(0));
        }
        return craftingRecipeInput.getRecipeMatcher().match(this, null);
    }
