    ...
    public static void registerDefaults() {
        ...
        DispenserBlock.registerBehavior(Items.ARMOR_STAND, new ItemDispenserBehavior(){
            ...
            public ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
                ...
                ArmorStandEntity armorStandEntity = EntityType.ARMOR_STAND.spawn(serverWorld, consumer = EntityType.copier(armorStand -> armorStand.setYaw(direction.asRotation()), serverWorld, stack, null), blockPos, SpawnReason.DISPENSER, false, false);
        ...
        FallibleItemDispenserBehavior itemDispenserBehavior2 = new FallibleItemDispenserBehavior(){
            ...
            protected ItemStack dispenseSilently(BlockPointer pointer, ItemStack stack) {
                BlockPos blockPos = pointer.pos().offset(pointer.state().get(DispenserBlock.FACING));
                List<AbstractHorseEntity> list = pointer.world().getEntitiesByClass(AbstractHorseEntity.class, new Box(blockPos), horse -> horse.isAlive() && horse.canUseSlot(EquipmentSlot.BODY));
                for (AbstractHorseEntity abstractHorseEntity : list) {
                    if (!abstractHorseEntity.isHorseArmor(stack) || abstractHorseEntity.isWearingBodyArmor() || !abstractHorseEntity.isTame()) continue;
